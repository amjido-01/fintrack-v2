    ...
    <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-wrap justify-center mt-6 -mx-4">
                <a href="#" className="mx-4 text-sm text-white transition-colors duration-300" aria-label="Reddit"> Home </a>
                
                <a href="#" className="mx-4 text-sm text-white transition-colors duration-300" aria-label="Reddit"> About </a>
                
                <a href="#" className="mx-4 text-sm text-white transition-colors duration-300" aria-label="Reddit"> Teams </a>

                <a href="#" className="mx-4 text-sm text-white transition-colors duration-300" aria-label="Reddit"> Privacy </a>

                <a href="#" className="mx-4 text-sm text-white transition-colors duration-300" aria-label="Reddit"> Cookies </a>
            </div>
